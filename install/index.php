...
if (isset($_POST['lng']) && ($_POST['lng'] == 'vi' || $_POST['lng'] == 'en')) {
...
switch ($act) {
    ...
    case 'set':
        ...
        $db_name = isset($_POST['dbname']) ? htmlentities(trim($_POST['dbname'])) : 'dol';
        ...
        if ($db_check && isset($_POST['install'])) {
            ...
            if ($db_check && empty($site_error) && empty($admin_error)) {
                ...
                foreach (glob('../system/language/*/lng.ini') as $val) {
